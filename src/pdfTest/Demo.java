...
//        System.out.println(t.demoPushDeviceListMultiple());
    ...
    protected JSONObject demoPushSingleAccount() {
        ...
        message.setContent("content");
        message.setType(Message.TYPE_MESSAGE);
        JSONObject ret = xinge.pushSingleAccount(0, "nickName", message);
        return ret;
    }
...
//        XingeApp xinge = new XingeApp(000, "secret_key");
        XingeApp xinge = new XingeApp(2100272892, "1cb0279b9105ba154ecdf3e53998fe9c");
        buildMesssges();
    }
...
//    http://openapi.xg.qq.com/v2/class/method?params
